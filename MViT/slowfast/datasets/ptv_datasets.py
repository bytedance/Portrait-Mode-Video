...
def Ptvkinetics(cfg, mode):
    ...
    path_to_file = os.path.join(
        cfg.DATA.PATH_TO_DATA_DIR, cfg.DATA.LABEL_PATH_TEMPLATE.format(mode, cfg.DATA.PM_SUBSET)
    )
    labeled_video_paths = LabeledVideoPaths.from_path(path_to_file, cfg.DATA.PATH_LABEL_SEPARATOR)
