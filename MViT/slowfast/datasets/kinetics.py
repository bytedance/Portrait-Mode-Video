...
class Kinetics(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            f_out, time_idx_out, pm = [None] * num_out, [None] * num_out, [None] * num_out
            idx = -1
            ...
            for i in range(num_decode):
                for _ in range(num_aug):
                    ...
                    if (self.mode in ['train', 'val'] and self.cfg.DATA.TRAIN_CROP_SIZE_RECT_SWITCH_AUTO) or \
                        ...
                        if H > W:
                            f_out[idx] = f_out[idx].transpose(-2,-1)
                            pm[idx] = True
                        else:
                            pm[idx] = False
                    else:
            ...
            # if sum(pm) == 1:
            #     print(pm)
            return frames, label, index, time_idx, {"pm":pm}
        else:
            logger.warning(
