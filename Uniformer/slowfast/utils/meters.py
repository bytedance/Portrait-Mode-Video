...
class TestMeter(object):
    ...
    def update_stats(self, preds, labels, clip_ids):
        ...
        for ind in range(preds.shape[0]):
            try:
                ...
                print(len(clip_ids), clip_ids, ind, self.num_clips)
                raise e
            if self.video_labels[vid_id].sum() > 0:
                try:
                    ...
                    print(self.video_labels, len(self.video_labels), vid_id, ind, labels, len(labels))
                    raise e
    ...
    def finalize_metrics(self, ks=(1, 5)):
        ...
        self.stats_dense_spatial.append(self.stats)
        print(self.stats_dense_spatial)
